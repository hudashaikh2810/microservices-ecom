    ...
    * This bean tells how to create a kafka consumer */
    ...
    public ConsumerFactory<String, ProductCreatedEvent> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(),
                new JsonDeserializer<>(ProductCreatedEvent.class).ignoreTypeHeaders().trustedPackages("*"));
    }
/*
...
* */
    ...
    public NewTopic userCreatedDlt() {
        return TopicBuilder.name("inventory-created.DLT")
                .partitions(3)  // match main topic
                .replicas(1)
                .build();
    }
    @Bean
    public NewTopic inventoryCreated() {
